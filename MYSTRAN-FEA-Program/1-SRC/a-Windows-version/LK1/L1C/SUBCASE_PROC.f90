...
!     CCELDT( 0) is for print to BUGFIL text file of elem geometric data
!     CCELDT( 1) is for print to BUGFIL text file of elem prop, matl and other data
!     CCELDT( 2) is for print to BUGFIL text file of element ME
!     CCELDT( 3) is for print to BUGFIL text file of element PTE, PPE
!     CCELDT( 4) is for print to BUGFIL text file of element KE
!     CCELDT( 5) is for print to BUGFIL text file of element SE1,2,3 STE1,2,3
!     CCELDT( 6) is for print of UEL, PEL (all subcases)
!     CCELDT( 7) is for print outputs from subr's MIN4SH, SHP2D, SHP3D, JAC2D, JAC3D on elem shape fcns and Jacobian matrices
!     CCELDT( 8) is for print strain-displacement matrices in subroutines BMQMEM, BBDKQ, BHEX, BSMIN3, BSMIN4, BBMIN3, BBMIN4
!     CCELDT( 9) is for print check on element strain-displ matrices for rigid body motion and constant strain (subr BCHECK)
!     CCELDT(10) is for write to F21FIL unformatted file of element ME
!     CCELDT(11) is for write to F22FIL unformatted file of element PTE, PPE
!     CCELDT(12) is for write to F23FIL unformatted file of element KE
!     CCELDT(13) is for write to F24FIL unformatted file of element SE1,2,3 STE1,2,3
!     CCELDT(14) is for write to F25FIL unformatted file of UEL, PEL (all subcases)
!     CCELDT(15) is currently not used
...
! Bit position  0 in OELDT, ELDT is for requesting printed output of elem geom data
! Bit position  1 in OELDT, ELDT is for requesting printed output of elem prop, matl and other data
! Bit position  2 in OELDT, ELDT is for requesting printed output of elem mass.
! Bit position  3 in OELDT, ELDT is for requesting printed output of elem thermal and pressure loads.
! Bit position  4 in OELDT, ELDT is for requesting printed output of elem stiffness matrix.
! Bit position  5 in OELDT, ELDT is for requesting printed output of elem stress recovery matrices.
! Bit position  6 in OELDT, ELDT is for requesting printed output of elem displs and loads.
! Bit position  7 in OELDT, ELDT is for requesting printed output of elem shape fcns and Jacobian matrices from subr's HEXA, etc.
! Bit position  8 in OELDT, ELDT is for requesting printed output of strain-displacement matrices in subroutines BMQMEM, etc.
! Bit position  9 in OELDT, ELDT is for requesting printed output of elem rigid body and constant strain checks (subr BCHECK).
! Bit position 10 in OELDT, ELDT is for requesting unformatted file output of elem mass.
! Bit position 11 in OELDT, ELDT is for requesting unformatted file output of elem thermal and pressure loads.
! Bit position 12 in OELDT, ELDT is for requesting unformatted file output of elem stiffness matrix.
! Bit position 13 in OELDT, ELDT is for requesting unformatted file output of elem stress recovery matrices.
! Bit position 14 in OELDT, ELDT is for requesting unformatted file output of elem displs and loads.
...
! **********************************************************************************************************************************
 ...
 1034 FORMAT(1X                                                                                                                 ,/,&
             ' Bit position  0 is for requesting printed output of element grid geometric data'                                 ,/,&
             ' Bit position  1 is for requesting printed output of element property, material and other data'                   ,/,&
             ' Bit position  2 is for requesting printed output of element nodal mass.'                                         ,/,&
             ' Bit position  3 is for requesting printed output of element thermal and pressure loads in local element coords.' ,/,&
             ' Bit position  4 is for requesting printed output of element stiffness matrix in local element coords.'           ,/,&
             ' Bit position  5 is for requesting printed output of element stress recovery matrices in local element coords.'   ,/,&
             ' Bit position  6 is for requesting printed output of element displacements and nodal loads.'                      ,/,&
             ' Bit position  7 is for printed output of strain-displacement matrices in subroutines BMQMEM, etc.'               ,/,&
             ' Bit position  8 is for printed output of elem shape fcns and Jacobian matrices from subroutines HEXA, etc.'      ,/,&
             ' Bit position  9 is for printed output of elem rigid body and constant strain checks (subroutine BCHECK).'        ,/,&
             ' Bit position 10 is for requesting unformatted file output of element mass.'                                      ,/,&
             ' Bit position 11 is for requesting unformatted file output of element thermal and pressure loads.'                ,/,&
             ' Bit position 12 is for requesting unformatted file output of element stiffness matrix.'                          ,/,&
             ' Bit position 13 is for requesting unformatted file output of element stress recovery matrices.'                  ,/,&
             ' Bit position 14 is for requesting unformatted file output of element displs and loads.'                          ,/,&
             ' Bit position 15 is not used.')

...
!  - process differential stiffness resulting in a sparse array of differential stiffness values
      ...
      CHARACTER( 1*BYTE)              :: F21OPN     = 'N'  ! 'Y'/'N' depending on whether file F21FIL is open
      CHARACTER( 1*BYTE)              :: F22OPN     = 'N'  ! 'Y'/'N' depending on whether file F22FIL is open
      CHARACTER( 1*BYTE)              :: F23OPN     = 'N'  ! 'Y'/'N' depending on whether file F23FIL is open
      CHARACTER( 1*BYTE)              :: F24OPN     = 'N'  ! 'Y'/'N' depending on whether file F24FIL is open

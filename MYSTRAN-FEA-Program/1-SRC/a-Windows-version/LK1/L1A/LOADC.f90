...
! LOADC reads in the CASE CONTROL DECK
      ...
      CHARACTER(LEN=CC_ENTRY_LEN)     :: CARD0             ! Case Control card
      ...
      INTEGER(LONG)                   :: DATA_BEGN         ! Column number on CARD where actual data begins
...
! **********************************************************************************************************************************
 ...
 1038 FORMAT(' *ERROR  1038: FOR BUCKLING ANALYSES THERE MUST BE 2 SUBCASES WITH A LOAD (AND/OR TEMP) DEFINED IN SUBCASE 1')

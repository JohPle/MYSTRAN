...
! LOADE reads in the EXEC CONTROL DECK
      ...
      CHARACTER(LEN=EC_ENTRY_LEN)     :: CARD0             ! Case Control card
...
! *******************************************************************************************************************************
! In released versions, comment out the following until BUCKLING code is completed
                  ELSE IF ((TOKEN(1) == 'DIFFEREN') .OR. (TOKEN(1) == 'DIFF STI')) THEN
                     SOL_NAME(1:7)  =  'DIFFEREN'
                     SOL_INT        = 4

                  ELSE IF ((TOKEN(1) == 'BUCKLING') .OR. (TOKEN(1) == 'SEBUCKL')) THEN
                     SOL_NAME(1:7)  =  'BUCKLING'
                     SOL_INT        = 5
...
! *******************************************************************************************************************************
               ...
               ELSE IF (TOKTYP(1) == 'INTEGER ') THEN      ! TOKEN(1) is the integer SOL_INT value
                  ...
                  ELSE IF ((SOL_INT == 3 ) .OR. (SOL_INT == 103))  THEN
                     SOL_NAME(1:5) = 'MODES'
! **********************************************************************************************************************************
! In released versions, comment out the following 2 lines until BUCKLING code is completed

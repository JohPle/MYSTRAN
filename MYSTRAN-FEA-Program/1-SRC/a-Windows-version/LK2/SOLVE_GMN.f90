...
! The GMN data in SCRATCH-991 is written 1 col at a time. We need it to be written for 1 row at a time with rows in numerical order
      ...
      CLOSE_IT   = 'N'
      CLOSE_STAT = 'KEEP    '
      CALL READ_MATRIX_2 (SCRFIL, SCR(1), OPND, CLOSE_IT, CLOSE_STAT, MESSAG,'GMN',NDOFM, NTERM_GMN, NTERM_READ, I2_GMN, J_GMN, GMN)
...
! Reallocate memory to GMN based on the NTERM_GMN counted above and read values from scratch file into GMN arrays
      ...
      CLOSE_IT   = 'Y'
      CLOSE_STAT = 'DELETE  '
      CALL READ_MATRIX_1 ( SCRFIL, SCR(1), OPND, CLOSE_IT, CLOSE_STAT, MESSAG, 'GMN', NTERM_GMN, NTERM_READ, NDOFM,                &
                           I_GMN, J_GMN, GMN)

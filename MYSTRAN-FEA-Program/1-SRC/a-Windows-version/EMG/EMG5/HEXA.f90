      ...
      DO K=1,IORD
         DO J=1,IORD
            DO I=1,IORD
               ...
               CALL JAC3D ( DPSHG, 'Y', JAC, JACI, DETJ(GAUSS_PT) )
...
! **********************************************************************************************************************************
! Calculate SEi, STEi matrices for stress data recovery. All stresses calculated at center of element
      ...
      IF (OPT(3) == 'Y') THEN
         ...
         CALL SHP3DH ( 0, 0, 0, ELGP, SUBR_NAME, 'UNITY ', 1, ZERO, ZERO, ZERO, 'N', PSH, DPSHG )
         CALL JAC3D ( DPSHG, 'N', JAC, JACI, DETJ(GAUSS_PT) )
         CALL MATMULT_FFF ( JACI, DPSHG, 3, 3, ELGP, DPSHX )

...
!                                                            =2-1, rotate stress from elem mat'l to ply axes (when recov stresses)
      ...
      REAL(DOUBLE)                    :: T2Mt(3,3)         ! Transpose of T2M
...
!xxx           T2T3  = T2T(I,J)
      ...
      ELSE
         ...
         FATAL_ERR = FATAL_ERR
         WRITE(ERR,1947) SUBR_NAME, DIRECTION
         WRITE(F06,1947) SUBR_NAME, DIRECTION
         CALL OUTA_HERE ( 'Y' )
...
! **********************************************************************************************************************************
 1947 FORMAT(' *ERROR  194T: PROGRAMMING ERROR IN SUBROUTINE ',A                                                                   &

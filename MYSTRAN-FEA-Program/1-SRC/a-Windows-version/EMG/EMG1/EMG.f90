! ##################################################################################################################################
      ...
      SUBROUTINE EMG ( INT_ELEM_ID, OPT, WRITE_WARN, CALLING_SUBR )
...
! **********************************************************************************************************************************
      ...
      IF (WRT_LOG >= SUBR_BEGEND) THEN
         CALL OURTIM
         WRITE(F04,9001) SUBR_NAME,TSEC,EID,TYPE
 9001    FORMAT(1X,A,' BEGN ',F10.3,5X,'Element No. ',I8,' ,Type ',A)
      ENDIF
...
! **********************************************************************************************************************************
! Call ELMOUT to output for data items 2, 3, 4

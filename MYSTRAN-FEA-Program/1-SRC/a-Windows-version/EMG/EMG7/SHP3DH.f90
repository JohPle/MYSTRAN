...
! ELDATA output:
      ...
      IF ((WRT_BUG_THIS_TIME == 'Y') .AND.(WRT_BUG(7) > 0)) THEN
         ...
         WRITE(BUG,1102) IGAUS, JGAUS, KGAUS, INT_ORDER_MSG, IORZZZ
...
! **********************************************************************************************************************************
 ...
 1102 FORMAT(47X,' Gauss point: I = ',I3,', J = ',I3,', K = ',I3,/,35X,'with integration order ',A,I2,/,                           &
             35X,'and using Gaussian integration to determine strain-displ matrix'//)

 1112 format(51x,'Outputs fron subroutine SHP3DH',/,51x,'------------------------------',/)

...
! ELDATA output:
      ...
      IF ((WRT_BUG_THIS_TIME == 'Y') .AND.(WRT_BUG(7) > 0)) THEN
         ...
         WRITE(BUG,1102) GAUSS_PT, INT_ORDER, IORZZZ
...
! **********************************************************************************************************************************
 ...
 1102 FORMAT(57X,' Gauss point = ',I3,/,35X,'with integration order ',A,I2,/,                           &
             35X,'and using Gaussian integration to determine strain-displ matrix'//)

 1112 format(51x,'Outputs fron subroutine SHP3DT',/,51x,'------------------------------',/)

! ##################################################################################################################################
      ...
      SUBROUTINE SHP3DP ( IGAUS, JGAUS, KGAUS, NUM_NODES, CALLING_SUBR, INT_ORDER_MSG, INT_ORD_IJ, INT_ORD_K, SSI, SSJ, SSK,       &
...
! ELDATA output:
      ...
      IF ((WRT_BUG_THIS_TIME == 'Y') .AND.(WRT_BUG(7) > 0)) THEN
         ...
         WRITE(BUG,1102) IGAUS, JGAUS, KGAUS, INT_ORDER_MSG, INT_ORD_IJ, INT_ORD_K
...
! **********************************************************************************************************************************
 ...
 1102 FORMAT(47X,' Gauss point: I = ',I3,', J = ',I3,', K = ',I3,/,35X,'with integration order ',A,I2,'x',I2,/,                    &
             35X,'and using Gaussian integration to determine strain-displ matrix'//)

 1112 format(51x,'Outputs fron subroutine SHP3DP',/,51x,'------------------------------',/)

 1103 FORMAT(53X,'Coordinates of Gauss point',/,49x,'XI              ET              ZI',/,40X,3(1ES16.6),//)

 1105 FORMAT(59X,'Shape functions')

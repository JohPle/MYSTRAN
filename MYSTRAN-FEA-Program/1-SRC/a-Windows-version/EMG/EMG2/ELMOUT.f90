...
! Write output from ELMGMi
            ...
            WRITE(BUG,*) '  --------------------------------------------------------------------'
            WRITE(BUG,*) '         Grid Number                 Local Element System Coords'
            WRITE(BUG,*) '  Actual  Internal  Element        X              Y              Z'
            DO I=1,ELGP
...
! Element mass
      ...
      IF (WRT_WHAT_BUG(2) > 0) THEN

         WRITE(BUG,1000)

         WRITE(BUG,1001) ELDT_BUG_MASS_BIT, TYPE, EID
...
!zzzz    IF (PCOMP_PROPS == 'N') THEN
            ...
            IF (NTSUB > 0) THEN
               ...
               DO K=1,NUM_STRESS_MATS
                  WRITE(BUG,*) '  STE1 matrix for thermal stress/strain effects'
                  WRITE(BUG,*) '  ---------------------------------------------'
                  DO J=1,NTSUB
                     WRITE(BUG,*) '  Column',J
               ...
               DO K=1,NUM_STRESS_MATS
                  WRITE(BUG,*) '  STE2 matrix for thermal stress/strain effects'
                  WRITE(BUG,*) '  ---------------------------------------------'
                  DO J=1,NTSUB
                     WRITE(BUG,*) '  Column',J
               ...
               DO K=1,NUM_STRESS_MATS
                  WRITE(BUG,*) '  STE3 matrix for thermal stress/strain effects'
                  WRITE(BUG,*) '  ---------------------------------------------'
                  DO J=1,NTSUB
                     WRITE(BUG,*) '  Column',J
...
! **********************************************************************************************************************************
 ...
 1004 FORMAT(1X,I8,2X,I8,I6,2X,3(1ES15.6))

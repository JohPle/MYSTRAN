...
!nnn  DLL_IMPORT MATMULT_FFF_T
      ...
      CHARACTER(39*BYTE)              :: IORD_MSG          ! Character name of the integration order (used for debug output)
      ...
      REAL(DOUBLE)                    :: F1, F2            ! Effectiveness factor for rod extension stiffness on shear panel edges
      REAL(DOUBLE)                    :: ROD_A1, ROD_A2    ! Areas of extensional rods on shear panel edges

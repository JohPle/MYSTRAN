...
!nnn  DLL_EXPORT QDEL1
!nnn  DLL_IMPORT OURTIM
!nnn  DLL_IMPORT ORDER_GAUSS
!nnn  DLL_IMPORT JAC2D
!nnn  DLL_IMPORT QMEM1
!nnn  DLL_IMPORT QPLT1
!nnn  DLL_IMPORT QPLT2
!nnn  DLL_IMPORT QPLT3
            ...
            IF      (TYPE(1:5) == 'QUAD4') THEN
               ...
               DO I=1,IORD_PCOMP
                  ...
                  DO J=1,IORD_PCOMP
                     ...
                     CALL JAC2D ( SSS(I), SSS(J), XSD, YSD, 'Y', JAC, JACI, DETJ )

...
! The following are messages that describe what the files are (no message for SC1)
      ...
      CHARACTER( 64*BYTE)             :: OU4_MSG(MOU4) = (/'OUTPUT4 FILE 21','OUTPUT4 FILE 22','OUTPUT4 FILE 23',                  &
                                                           'OUTPUT4 FILE 24','OUTPUT4 FILE 25','OUTPUT4 FILE 26',                  &
                                                           'OUTPUT4 FILE 27','OUTPUT4 FILE 28','OUTPUT4 FILE 29'/)
...
! The following are unit numbers for all files used by the program
      ...
      INTEGER(LONG)                   :: SEQ           =   11 ! Unit no. for SEQGP card images from BANDIT
      INTEGER(LONG)                   :: SPC           =   12 ! Unit no. for SPC1 text file

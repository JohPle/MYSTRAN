...
! ----------------------------------------------------------------------------------------------------------------------------------
      CHARACTER(  7*BYTE)      :: MKLFAC21       = 'POSDEF ' ! Matrix type for decomp used in subr REDUCE_KAA_TO_KFF
      CHARACTER(  7*BYTE)      :: MKLFAC31       = 'POSDEF ' ! Matrix type for decomp used in subr LINK3
      CHARACTER(  7*BYTE)      :: MKLFAC41       = 'INDEF  ' ! Matrix type for decomp used in subr EIG_INV_PWR
      CHARACTER(  7*BYTE)      :: MKLFAC42       = 'INDEF  ' ! Matrix type for decomp used in subr EIG_LANCZOS_ARPACK (num eigs est)
      CHARACTER(  7*BYTE)      :: MKLFAC61       = 'POSDEF ' ! Matrix type for decomp used in subr CALC_KRRcb
      CHARACTER(  7*BYTE)      :: MKLFAC62       = 'POSDEF ' ! Matrix type for decomp used in subr SOLVE_DLR
      CHARACTER(  7*BYTE)      :: MKLFAC63       = 'POSDEF ' ! Matrix type for decomp used in subr SOLVE_PHIZL1

! ----------------------------------------------------------------------------------------------------------------------------------
      CHARACTER(  6*BYTE)      :: MKLMATST       = 'SYM '    ! Structure of matrix for DSS_DEFINE_STRUCTURE function in Intel MKL

! ----------------------------------------------------------------------------------------------------------------------------------
      CHARACTER(  1*BYTE)      :: MKLSTATS       = 'N'       ! If 'Y' write stats on matrix decomp in subr SYM_MAT_DECOMP_IntMKL
...
! ----------------------------------------------------------------------------------------------------------------------------------
      CHARACTER(  8*BYTE)      :: SOLLIB         = 'IntMKL'  ! If 'ZZPACK  ', use LAPACK and ARPACK for eqn soln and eigens
!                                                              If 'IntMKL  ', use Intel Math Kernel Library for eqn soln and eigens
!                                                             

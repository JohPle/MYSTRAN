...
! format of where xxx is the subroutine name.
      ...
      INTEGER(LONG), PARAMETER, PRIVATE :: ALLOCATE_BEGEND              = 1
      ...
      INTEGER(LONG), PARAMETER          :: BBDKQ_BEGEND                 = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BBMIN3_BEGEND                = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BBMIN4_BEGEND                = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BCHECK_BEGEND                = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: B3D_ISOPARAMETRIC_BEGEND     = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BMQMEM_BEGEND                = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BSMIN3_BEGEND                = ELEM_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: BSMIN4_BEGEND                = ELEM_BEGEND + 2
      ...
      INTEGER(LONG), PARAMETER          :: REPLACE_TABS_W_BLANKS_BEGEND = LINK_BEGEND + 3
      INTEGER(LONG), PARAMETER          :: READ_INCLUDE_FILNAM_BEGEND   = LINK_BEGEND + 3
      INTEGER(LONG), PARAMETER          :: RW_INCLUDE_FILES_BEGEND      = LINK_BEGEND + 3
      ...
      INTEGER(LONG), PARAMETER          :: TDOF_COL_NUM_BEGEND          = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: TSET_PROC_FOR_MPCS_BEGEND    = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: TSET_PROC_FOR_OMITS_BEGEND   = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: TSET_PROC_FOR_RIGELS_BEGEND  = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: TSET_PROC_FOR_SPCS_BEGEND    = LINK_BEGEND + 6
      ...
      INTEGER(LONG), PARAMETER          :: STOKEN_BEGEND                = LINK_BEGEND + 6
      ...
      INTEGER(LONG), PARAMETER          :: WRITE_GRID_OUTPUTS_BEGEND    = LINK_BEGEND + ELEM_BEGEND
      ...
      INTEGER(LONG), PARAMETER          :: FBS_IntMKL_BEGEND            = LINK_BEGEND
      ...
      INTEGER(LONG), PARAMETER          :: MATADD_FFF_BEGEND            = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: MATADD_SSS_BEGEND            = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATADD_SSS_NTERM_BEGEND      = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATMULT_FFF_BEGEND           = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: MATMULT_FFF_T_BEGEND         = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: MATMULT_SFF_BEGEND           = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATMULT_SFS_BEGEND           = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATMULT_SFS_NTERM_BEGEND     = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATMULT_SSS_BEGEND           = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATMULT_SSS_NTERM_BEGEND     = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATRIX_VECTOR_OP_BEGEND      = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: MATTRNSP_SS_BEGEND           = LINK_BEGEND + 2
      ...
      INTEGER(LONG), PARAMETER          :: PARSE_CHAR_STRING_BEGEND     = LINK_BEGEND + 6
      ...
      INTEGER(LONG), PARAMETER          :: RIGID_BODY_DISP_MAT_BEGEND   = LINK_BEGEND + 2
      INTEGER(LONG), PARAMETER          :: ROW_AT_COLJ_BEGEND_BEGEND    = LINK_BEGEND + 10
      INTEGER(LONG), PARAMETER          :: SORT_GRID_RGRID_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT1_BEGEND             = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT1_REAL1_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT1_REAL3_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT2_BEGEND             = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT2_REAL1_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT3_BEGEND             = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_INT3_CHAR2_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_REAL1_INT1_BEGEND       = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORT_TDOF_BEGEND             = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SORTLEN_BEGEND               = LINK_BEGEND + 3
      INTEGER(LONG), PARAMETER          :: SPARSE_CRS_SPARSE_CCS_BEGEND = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SPARSE_CRS_TERM_COUNT_BEGEND = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SPARSE_CRS_TO_FULL_BEGEND    = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SPARSE_MAT_DIAG_ZEROS_BEGEND = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SPARSE_NONSYM_TO_SYM_BEGEND  = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: STMERR_BEGEND                = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SURFACE_FIT_BEGEND           = LINK_BEGEND + 6
      INTEGER(LONG), PARAMETER          :: SYM_MAT_DECOMP_IntMKL_BEGEND = LINK_BEGEND
      INTEGER(LONG), PARAMETER          :: SYM_MAT_DECOMP_LAPACK_BEGEND = LINK_BEGEND
      INTEGER(LONG), PARAMETER          :: TIME_INIT_BEGEND             = LINK_BEGEND + 6

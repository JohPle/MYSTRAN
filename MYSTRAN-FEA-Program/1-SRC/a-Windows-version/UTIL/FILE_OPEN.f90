         ...
         ELSE IF (RW_STIME == 'WRITE_STIME') THEN          ! Write STIME  
            ...
            IF (WRITE_VER == 'Y') THEN
               IF (PROTECTED == 'Y') THEN
                  ...
                  WRITE(UNIT,116) PROG_NAME, MYSTRAN_VER_NUM, MYSTRAN_VER_MONTH, MYSTRAN_VER_DAY, MYSTRAN_VER_YEAR,                &
                                  MYSTRAN_VER_AUTH, ALLOWABLE_PROTECTED_SOLNS(1:IEND), MYSTRAN_COMMENT
               ELSE
                  WRITE(UNIT,117) PROG_NAME, MYSTRAN_VER_NUM, MYSTRAN_VER_MONTH, MYSTRAN_VER_DAY, MYSTRAN_VER_YEAR,                &
                                  MYSTRAN_VER_AUTH, MYSTRAN_COMMENT
               ENDIF
            ENDIF
         ENDIF
      ELSE
...
! **********************************************************************************************************************************
  ...
  116 FORMAT(/,1X,A,' Version',5(1X,A),' (this ',A,' edition is SP protected)',/,1X,A)

  117 FORMAT(/,1X,A,' Version',5(1X,A),' (this edition is not SP protected)',/,1X,A)

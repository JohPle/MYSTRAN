...
! the names of files opened for a run, the "counter" info (e.g. NGRID, number of grids, etc), solution number, PARAM's
      ...
      USE IOUNT1, ONLY                :  MOT4,    MOU4,    WRT_BUG, WRT_ERR, WRT_LOG, DEFDIR
...
! Write I/0 unit numbers, close status and names
      ...
      WRITE(L1A,151) SEQ,SEQSTAT,SEQ_MSG,SEQFIL            !  12
      WRITE(L1A,151) SPC,SPCSTAT,SPC_MSG,SPCFIL            !  13

      WRITE(L1A,151) F21,F21STAT,F21_MSG,F21FIL            !  14
      WRITE(L1A,151) F22,F22STAT,F22_MSG,F22FIL            !  15
      WRITE(L1A,151) F23,F23STAT,F23_MSG,F23FIL            !  16
      WRITE(L1A,151) F24,F24STAT,F24_MSG,F24FIL            !  17
      WRITE(L1A,151) F25,F25STAT,F25_MSG,F25FIL            !  18
      WRITE(L1A,151) L1B,L1BSTAT,L1B_MSG,LINK1B            !  19
      WRITE(L1A,151) L1C,L1CSTAT,L1C_MSG,LINK1C            !  20
      WRITE(L1A,151) L1D,L1DSTAT,L1D_MSG,LINK1D            !  21
      WRITE(L1A,151) L1E,L1ESTAT,L1E_MSG,LINK1E            !  22
      WRITE(L1A,151) L1F,L1FSTAT,L1F_MSG,LINK1F            !  23
      WRITE(L1A,151) L1G,L1GSTAT,L1G_MSG,LINK1G            !  24
      WRITE(L1A,151) L1H,L1HSTAT,L1H_MSG,LINK1H            !  25
      WRITE(L1A,151) L1I,L1ISTAT,L1I_MSG,LINK1I            !  26
      WRITE(L1A,151) L1J,L1JSTAT,L1J_MSG,LINK1J            !  27
      WRITE(L1A,151) L1K,L1KSTAT,L1K_MSG,LINK1K            !  28
      WRITE(L1A,151) L1L,L1LSTAT,L1L_MSG,LINK1L            !  29
      WRITE(L1A,151) L1M,L1MSTAT,L1M_MSG,LINK1M            !  30
      WRITE(L1A,151) L1N,L1NSTAT,L1N_MSG,LINK1N            !  31
      WRITE(L1A,151) L1O,L1OSTAT,L1O_MSG,LINK1O            !  32
      WRITE(L1A,151) L1P,L1PSTAT,L1P_MSG,LINK1P            !  33
      WRITE(L1A,151) L1Q,L1QSTAT,L1Q_MSG,LINK1Q            !  34
      WRITE(L1A,151) L1R,L1RSTAT,L1R_MSG,LINK1R            !  35
      WRITE(L1A,151) L1S,L1SSTAT,L1S_MSG,LINK1S            !  36
      WRITE(L1A,151) L1T,L1TSTAT,L1T_MSG,LINK1T            !  37
      WRITE(L1A,151) L1U,L1USTAT,L1U_MSG,LINK1U            !  38
      WRITE(L1A,151) L1V,L1VSTAT,L1V_MSG,LINK1V            !  39
      WRITE(L1A,151) L1W,L1WSTAT,L1W_MSG,LINK1W            !  40
      WRITE(L1A,151) L1W,L1WSTAT,L1X_MSG,LINK1X            !  41
      WRITE(L1A,151) L1Y,L1YSTAT,L1Y_MSG,LINK1Y            !  42
      WRITE(L1A,151) L1Z,L1ZSTAT,L1Z_MSG,LINK1Z            !  43
      WRITE(L1A,151) L2A,L2ASTAT,L2A_MSG,LINK2A            !  44
      WRITE(L1A,151) L2B,L2BSTAT,L2B_MSG,LINK2B            !  45
      WRITE(L1A,151) L2C,L2CSTAT,L2C_MSG,LINK2C            !  46
      WRITE(L1A,151) L2D,L2DSTAT,L2D_MSG,LINK2D            !  47
      WRITE(L1A,151) L2E,L2ESTAT,L2E_MSG,LINK2E            !  48
      WRITE(L1A,151) L2F,L2FSTAT,L2F_MSG,LINK2F            !  49
      WRITE(L1A,151) L2G,L2GSTAT,L2G_MSG,LINK2G            !  50
      WRITE(L1A,151) L2H,L2HSTAT,L2H_MSG,LINK2H            !  51
      WRITE(L1A,151) L2I,L2ISTAT,L2I_MSG,LINK2I            !  52
      WRITE(L1A,151) L2J,L2JSTAT,L2J_MSG,LINK2J            !  53
      WRITE(L1A,151) L2K,L2KSTAT,L2K_MSG,LINK2K            !  54
      WRITE(L1A,151) L2L,L2LSTAT,L2L_MSG,LINK2L            !  55
      WRITE(L1A,151) L2M,L2MSTAT,L2M_MSG,LINK2M            !  56
      WRITE(L1A,151) L2N,L2NSTAT,L2N_MSG,LINK2N            !  57
      WRITE(L1A,151) L2O,L2OSTAT,L2O_MSG,LINK2O            !  58
      WRITE(L1A,151) L2P,L2PSTAT,L2P_MSG,LINK2P            !  59
      WRITE(L1A,151) L2Q,L2QSTAT,L2Q_MSG,LINK2Q            !  60
      WRITE(L1A,151) L2R,L2QSTAT,L2R_MSG,LINK2R            !  61
      WRITE(L1A,151) L2S,L2QSTAT,L2S_MSG,LINK2S            !  62
      WRITE(L1A,151) L2T,L2QSTAT,L2T_MSG,LINK2T            !  63
      WRITE(L1A,151) L3A,L3ASTAT,L3A_MSG,LINK3A            !  64
      WRITE(L1A,151) L4A,L4ASTAT,L4A_MSG,LINK4A            !  65
      WRITE(L1A,151) L4B,L4BSTAT,L4B_MSG,LINK4B            !  66
      WRITE(L1A,151) L4C,L4CSTAT,L4C_MSG,LINK4C            !  67
      WRITE(L1A,151) L4D,L4DSTAT,L4D_MSG,LINK4D            !  68
      WRITE(L1A,151) L5A,L5ASTAT,L5A_MSG,LINK5A            !  69
      WRITE(L1A,151) L5B,L5BSTAT,L5B_MSG,LINK5B            !  70
      DO I=1,MOU4
         WRITE(L1A,151) OU4(I),OU4STAT(I),OU4FIL(I)        !  70+I
      ENDDO
      DO I=1,MOT4
...
! Write counter info from module SCONTR
      ...
      I = I + 1  ;     WRITE(L1A,160) SETLEN             , 'SETLEN                (303)'  !

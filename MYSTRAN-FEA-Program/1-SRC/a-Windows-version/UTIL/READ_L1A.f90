...
! Read I/0 unit no's and names. First, null IOCHKI since it won't be checked until after all records, below, are read.
      ...
      READ(L1A,151,IOSTAT=IOCHKI( 12)) SEQ,SEQSTAT,SEQ_MSG,SEQFIL
      READ(L1A,151,IOSTAT=IOCHKI( 13)) SPC,SPCSTAT,SPC_MSG,SPCFIL

      READ(L1A,151,IOSTAT=IOCHKI( 14)) F21,F21STAT,F21_MSG,F21FIL
      READ(L1A,151,IOSTAT=IOCHKI( 15)) F22,F22STAT,F22_MSG,F22FIL
      READ(L1A,151,IOSTAT=IOCHKI( 16)) F23,F23STAT,F23_MSG,F23FIL
      READ(L1A,151,IOSTAT=IOCHKI( 17)) F24,F24STAT,F24_MSG,F24FIL
      READ(L1A,151,IOSTAT=IOCHKI( 18)) F25,F25STAT,F25_MSG,F25FIL
      READ(L1A,151,IOSTAT=IOCHKI( 19)) L1B,L1BSTAT,L1B_MSG,LINK1B
      READ(L1A,151,IOSTAT=IOCHKI( 20)) L1C,L1CSTAT,L1C_MSG,LINK1C
      READ(L1A,151,IOSTAT=IOCHKI( 21)) L1D,L1DSTAT,L1D_MSG,LINK1D
      READ(L1A,151,IOSTAT=IOCHKI( 22)) L1E,L1ESTAT,L1E_MSG,LINK1E
      READ(L1A,151,IOSTAT=IOCHKI( 23)) L1F,L1FSTAT,L1F_MSG,LINK1F
      READ(L1A,151,IOSTAT=IOCHKI( 24)) L1G,L1GSTAT,L1G_MSG,LINK1G
      READ(L1A,151,IOSTAT=IOCHKI( 25)) L1H,L1HSTAT,L1H_MSG,LINK1H
      READ(L1A,151,IOSTAT=IOCHKI( 26)) L1I,L1ISTAT,L1I_MSG,LINK1I
      READ(L1A,151,IOSTAT=IOCHKI( 27)) L1J,L1JSTAT,L1J_MSG,LINK1J
      READ(L1A,151,IOSTAT=IOCHKI( 28)) L1K,L1KSTAT,L1K_MSG,LINK1K
      READ(L1A,151,IOSTAT=IOCHKI( 29)) L1L,L1LSTAT,L1L_MSG,LINK1L
      READ(L1A,151,IOSTAT=IOCHKI( 30)) L1M,L1MSTAT,L1M_MSG,LINK1M
      READ(L1A,151,IOSTAT=IOCHKI( 31)) L1N,L1NSTAT,L1N_MSG,LINK1N
      READ(L1A,151,IOSTAT=IOCHKI( 32)) L1O,L1OSTAT,L1O_MSG,LINK1O
      READ(L1A,151,IOSTAT=IOCHKI( 33)) L1P,L1PSTAT,L1P_MSG,LINK1P
      READ(L1A,151,IOSTAT=IOCHKI( 34)) L1Q,L1QSTAT,L1Q_MSG,LINK1Q
      READ(L1A,151,IOSTAT=IOCHKI( 35)) L1R,L1RSTAT,L1R_MSG,LINK1R
      READ(L1A,151,IOSTAT=IOCHKI( 36)) L1S,L1SSTAT,L1S_MSG,LINK1S
      READ(L1A,151,IOSTAT=IOCHKI( 37)) L1T,L1TSTAT,L1T_MSG,LINK1T
      READ(L1A,151,IOSTAT=IOCHKI( 38)) L1U,L1USTAT,L1U_MSG,LINK1U
      READ(L1A,151,IOSTAT=IOCHKI( 39)) L1V,L1VSTAT,L1V_MSG,LINK1V
      READ(L1A,151,IOSTAT=IOCHKI( 40)) L1W,L1WSTAT,L1W_MSG,LINK1W
      READ(L1A,151,IOSTAT=IOCHKI( 41)) L1X,L1XSTAT,L1X_MSG,LINK1X
      READ(L1A,151,IOSTAT=IOCHKI( 42)) L1Y,L1YSTAT,L1Y_MSG,LINK1Y
      READ(L1A,151,IOSTAT=IOCHKI( 43)) L1Z,L1ZSTAT,L1Z_MSG,LINK1Z
      READ(L1A,151,IOSTAT=IOCHKI( 44)) L2A,L2ASTAT,L2A_MSG,LINK2A
      READ(L1A,151,IOSTAT=IOCHKI( 45)) L2B,L2BSTAT,L2B_MSG,LINK2B
      READ(L1A,151,IOSTAT=IOCHKI( 46)) L2C,L2CSTAT,L2C_MSG,LINK2C
      READ(L1A,151,IOSTAT=IOCHKI( 47)) L2D,L2DSTAT,L2D_MSG,LINK2D
      READ(L1A,151,IOSTAT=IOCHKI( 48)) L2E,L2ESTAT,L2E_MSG,LINK2E
      READ(L1A,151,IOSTAT=IOCHKI( 49)) L2F,L2FSTAT,L2F_MSG,LINK2F
      READ(L1A,151,IOSTAT=IOCHKI( 50)) L2G,L2GSTAT,L2G_MSG,LINK2G
      READ(L1A,151,IOSTAT=IOCHKI( 51)) L2H,L2HSTAT,L2H_MSG,LINK2H
      READ(L1A,151,IOSTAT=IOCHKI( 52)) L2I,L2ISTAT,L2I_MSG,LINK2I
      READ(L1A,151,IOSTAT=IOCHKI( 53)) L2J,L2JSTAT,L2J_MSG,LINK2J
      READ(L1A,151,IOSTAT=IOCHKI( 54)) L2K,L2KSTAT,L2K_MSG,LINK2K
      READ(L1A,151,IOSTAT=IOCHKI( 55)) L2L,L2LSTAT,L2L_MSG,LINK2L
      READ(L1A,151,IOSTAT=IOCHKI( 56)) L2M,L2MSTAT,L2M_MSG,LINK2M
      READ(L1A,151,IOSTAT=IOCHKI( 57)) L2N,L2NSTAT,L2N_MSG,LINK2N
      READ(L1A,151,IOSTAT=IOCHKI( 58)) L2O,L2OSTAT,L2O_MSG,LINK2O
      READ(L1A,151,IOSTAT=IOCHKI( 59)) L2P,L2PSTAT,L2P_MSG,LINK2P
      READ(L1A,151,IOSTAT=IOCHKI( 60)) L2Q,L2QSTAT,L2Q_MSG,LINK2Q
      READ(L1A,151,IOSTAT=IOCHKI( 61)) L2R,L2RSTAT,L2R_MSG,LINK2R
      READ(L1A,151,IOSTAT=IOCHKI( 62)) L2S,L2SSTAT,L2S_MSG,LINK2S
      READ(L1A,151,IOSTAT=IOCHKI( 63)) L2T,L2TSTAT,L2T_MSG,LINK2T
      READ(L1A,151,IOSTAT=IOCHKI( 64)) L3A,L3ASTAT,L3A_MSG,LINK3A
      READ(L1A,151,IOSTAT=IOCHKI( 65)) L4A,L4ASTAT,L4A_MSG,LINK4A
      READ(L1A,151,IOSTAT=IOCHKI( 66)) L4B,L4BSTAT,L4B_MSG,LINK4B
      READ(L1A,151,IOSTAT=IOCHKI( 67)) L4C,L4CSTAT,L4C_MSG,LINK4C
      READ(L1A,151,IOSTAT=IOCHKI( 68)) L4D,L4DSTAT,L4D_MSG,LINK4D
      READ(L1A,151,IOSTAT=IOCHKI( 69)) L5A,L5ASTAT,L5A_MSG,LINK5A
      READ(L1A,151,IOSTAT=IOCHKI( 70)) L5B,L5BSTAT,L5B_MSG,LINK5B

      DO I=1,MOU4 
         READ(L1A,151,IOSTAT=IOCHKI(70+I)) OU4(I),OU4STAT(I),OU4FIL(I)
      ENDDO 
      DO I=1,MOT4 
         READ(L1A,151,IOSTAT=IOCHKI(70+MOU4+I)) OT4(I),OT4STAT(I),OT4FIL(I)
      ENDDO 
      DO I=1,70+MOT4+MOU4
         IF (IOCHKI(I) /= 0) THEN
            REC_NO = I
...
! Read counter info. First, null IOCHK since it won't be checked until after all records, below, are read
      ...
      READ(L1A,160,IOSTAT=IOCHKI(303)) SETLEN              ! 303 (From module SCONTR)

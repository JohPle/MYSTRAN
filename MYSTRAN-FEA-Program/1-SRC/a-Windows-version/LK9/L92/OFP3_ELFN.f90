...
elems_1: DO J = 1,NELE
            ...
            IF (ETYPE(J) == ELMTYP(I)) THEN
               ...
               IF ((ELOUT_ELFN > 0) .OR. (WRT_BUG(6) > 0) .OR. (WRT_FIJ(5) > 0)) THEN
                  PLY_NUM = 0
                  ...
                  IF (WRT_BUG(6) > 0) THEN                 ! Use 0 for num plies since it doesn't matter for this BUG output
                     CALL ELMOUT ( J, WRT_BUG, SCNUM(INT_SC_NUM), OPT )
                  ENDIF

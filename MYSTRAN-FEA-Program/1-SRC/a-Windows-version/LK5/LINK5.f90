...
! Read GMN matrix if there are MPC's
      ...
      IF (NTERM_GMN > 0) THEN
         ...
         OPND       = 'N'
         CLOSE_IT   = 'Y'
         CALL READ_MATRIX_1 ( LINK2A, L2A, OPND, CLOSE_IT, 'KEEP', L2A_MSG, 'GMN', NTERM_GMN, NTERM_READ, NDOFM                    &
                            , I_GMN, J_GMN, GMN )
      ENDIF 
...
! Read GOA matrix if there are omitted DOFs
      ...
      IF (NTERM_GOA > 0) THEN
         ...
         CLOSE_IT   = 'Y'
         CLOSE_STAT = L2ESTAT
         CALL READ_MATRIX_1 ( LINK2E, L2E, OPND, CLOSE_IT, CLOSE_STAT, L2E_MSG, 'GOA', NTERM_GOA, NTERM_READ, NDOFO                &
                            , I_GOA, J_GOA, GOA )
      ENDIF
